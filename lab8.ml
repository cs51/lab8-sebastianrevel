...
......................................................................*)
  ...
  let remove_listener (evt : 'a event) (i : id) : unit =
    let lst = !evt in
    evt := List.filter (fun x -> not (x.id = i)) lst ;;
    (* let rec remover evt i (seen : 'a event) =
    let e = !evt in
    match e with
    | h :: t -> if h.id = i then evt := (!seen @ t)
      else remover (ref t) i  (ref (h :: !seen))
    | [] -> evt := !evt in remover evt i (ref []) ;; *)
...
......................................................................*)
  ...
  let lst = !evt in
  ignore (List.map (fun x -> x.action arg) lst) ;;
